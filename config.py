...
_C.output_dir = osp.join(_C.working_dir, 'output')
_C.snapshot_dir = osp.join(_C.working_dir, 'checkpoints')
...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.working_dir, 'data')
_C.data.overlap_ratios = [1]
_C.data.rot_max_deg = 45.0
_C.data.trans_range = 0.5
...
# model - backbone
_C.backbone = edict()
_C.backbone.num_stages = 2
_C.backbone.init_voxel_size = 0.1
_C.backbone.kernel_size = 7
...
_C.coarse_matching.num_targets = 32
...
_C.geotransformer.input_dim = 128
_C.geotransformer.hidden_dim = 16
_C.geotransformer.output_dim = 256
_C.geotransformer.num_heads = 2
...
_C.fine_matching.acceptance_radius = 0.01
