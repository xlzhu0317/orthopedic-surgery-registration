...
from src.modules.ops import grid_subsample, radius_search
from src.utils.torch import build_dataloader
...
def registration_collate_fn_stack_mode(
    ...
    if 'transform' in collated_dict:
        collated_dict['transform'] = torch.stack(collated_dict['transform'], dim=0)
